 ...
 *
 * YUVLoader is free software: you can redistribute it and/or modify
 * it under the terms of the GNU General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 *
 * YUVLoader is distributed in the hope that it will be useful,
...
//    printf("SESSION CREATED");
    ...
    const string pathToGraph = "../resources/archive/Paper200_rate/Paper200_rate-116064.meta";
    const string checkpointPath = "../resources/archive/Paper200_rate/Paper200_rate-116064";
